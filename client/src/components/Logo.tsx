...
export const Logo = (props: SvgIconProps) => {
  return (
    <SvgIcon {...props} viewBox="-3.36 -3.36 30.72 30.72">
      <rect x="-3.36" y="-3.36" width="30.72" height="30.72" rx="15.36" fill="#ff7f50" />
      <g stroke="#ffffff" strokeWidth="1.91" fill="none">
        ...
        <rect x="7.23" y="13.91" width="3.82" height="8.59" rx="1.91" transform="rotate(180 9.14 18.21)" />
        <path
        ...
        />
        <rect x="16.3" y="10.57" width="3.82" height="8.59" rx="1.91" transform="rotate(90 18.21 14.87)" />
        <path
        ...
        />
        <rect x="3.89" y="4.84" width="3.82" height="8.59" rx="1.91" transform="rotate(-90 5.8 9.14)" />
        <path
